...
app.post('/api/add_torrent_to_group', api.verifyCredentialsFilter, api.addTorrentToGroup);
app.post('/api/delete_torrent_from_group', api.verifyCredentialsFilter, api.deleteTorrentFromGroup);
